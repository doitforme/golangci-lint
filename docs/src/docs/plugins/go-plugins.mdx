...
1. If the project you want to lint does not have one already, copy the [.golangci.yml](https://github.com/doitforme/golangci-lint/blob/HEAD/.golangci.yml) to the root directory.
