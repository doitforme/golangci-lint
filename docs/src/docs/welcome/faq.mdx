...
3. If it doesn't help create a [GitHub issue](https://github.com/doitforme/golangci-lint/issues/new/choose) with the output from the error and #2 above.
...
Or you can create a [GitHub Issue](https://github.com/doitforme/golangci-lint/issues/new?assignees=&labels=enhancement&projects=&template=feature_request.yml) and we will integrate when time permits.
