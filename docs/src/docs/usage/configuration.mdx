...
There is a [`.golangci.reference.yml`](https://github.com/doitforme/golangci-lint/blob/HEAD/.golangci.reference.yml) file with all supported options, their description, and default values.
