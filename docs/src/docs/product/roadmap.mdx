...
[See Feature Requests](https://github.com/doitforme/golangci-lint/issues?utf8=✓&q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc+label%3Aenhancement)

## 🐛 Bugs

Please file an issue for bugs, missing documentation, or unexpected behavior.

[See Bugs](https://github.com/doitforme/golangci-lint/issues?utf8=✓&q=is%3Aissue+is%3Aopen+label%3A%22bug%22+sort%3Acreated-desc)
...
For example, in our [GitHub Action](https://github.com/doitforme/golangci-lint-action) we require users to explicitly set the minor version of `golangci-lint`
