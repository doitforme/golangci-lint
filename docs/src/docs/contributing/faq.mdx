...
We use [Dependabot](https://github.com/doitforme/golangci-lint/blob/HEAD/.github/dependabot.yml) to update dependencies, including linters.
...
Add a new field to the [linter settings struct](https://github.com/doitforme/golangci-lint/blob/HEAD/pkg/config/linters_settings.go).
Document it in [.golangci.next.reference.yml](https://github.com/doitforme/golangci-lint/blob/HEAD/.golangci.next.reference.yml).
