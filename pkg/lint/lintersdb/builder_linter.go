...
import (
	...
	"github.com/doitforme/golangci-lint/pkg/golinters"
	"github.com/doitforme/golangci-lint/pkg/golinters/asasalint"
	"github.com/doitforme/golangci-lint/pkg/golinters/asciicheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/bidichk"
	"github.com/doitforme/golangci-lint/pkg/golinters/bodyclose"
	"github.com/doitforme/golangci-lint/pkg/golinters/canonicalheader"
	"github.com/doitforme/golangci-lint/pkg/golinters/containedctx"
	"github.com/doitforme/golangci-lint/pkg/golinters/contextcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/copyloopvar"
	"github.com/doitforme/golangci-lint/pkg/golinters/cyclop"
	"github.com/doitforme/golangci-lint/pkg/golinters/decorder"
	"github.com/doitforme/golangci-lint/pkg/golinters/depguard"
	"github.com/doitforme/golangci-lint/pkg/golinters/dogsled"
	"github.com/doitforme/golangci-lint/pkg/golinters/dupl"
	"github.com/doitforme/golangci-lint/pkg/golinters/dupword"
	"github.com/doitforme/golangci-lint/pkg/golinters/durationcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/err113"
	"github.com/doitforme/golangci-lint/pkg/golinters/errcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/errchkjson"
	"github.com/doitforme/golangci-lint/pkg/golinters/errname"
	"github.com/doitforme/golangci-lint/pkg/golinters/errorlint"
	"github.com/doitforme/golangci-lint/pkg/golinters/exhaustive"
	"github.com/doitforme/golangci-lint/pkg/golinters/exhaustruct"
	"github.com/doitforme/golangci-lint/pkg/golinters/exptostd"
	"github.com/doitforme/golangci-lint/pkg/golinters/fatcontext"
	"github.com/doitforme/golangci-lint/pkg/golinters/forbidigo"
	"github.com/doitforme/golangci-lint/pkg/golinters/forcetypeassert"
	"github.com/doitforme/golangci-lint/pkg/golinters/funlen"
	"github.com/doitforme/golangci-lint/pkg/golinters/gci"
	"github.com/doitforme/golangci-lint/pkg/golinters/ginkgolinter"
	"github.com/doitforme/golangci-lint/pkg/golinters/gocheckcompilerdirectives"
	"github.com/doitforme/golangci-lint/pkg/golinters/gochecknoglobals"
	"github.com/doitforme/golangci-lint/pkg/golinters/gochecknoinits"
	"github.com/doitforme/golangci-lint/pkg/golinters/gochecksumtype"
	"github.com/doitforme/golangci-lint/pkg/golinters/gocognit"
	"github.com/doitforme/golangci-lint/pkg/golinters/goconst"
	"github.com/doitforme/golangci-lint/pkg/golinters/gocritic"
	"github.com/doitforme/golangci-lint/pkg/golinters/gocyclo"
	"github.com/doitforme/golangci-lint/pkg/golinters/godot"
	"github.com/doitforme/golangci-lint/pkg/golinters/godox"
	"github.com/doitforme/golangci-lint/pkg/golinters/gofmt"
	"github.com/doitforme/golangci-lint/pkg/golinters/gofumpt"
	"github.com/doitforme/golangci-lint/pkg/golinters/goheader"
	"github.com/doitforme/golangci-lint/pkg/golinters/goimports"
	"github.com/doitforme/golangci-lint/pkg/golinters/gomoddirectives"
	"github.com/doitforme/golangci-lint/pkg/golinters/gomodguard"
	"github.com/doitforme/golangci-lint/pkg/golinters/goprintffuncname"
	"github.com/doitforme/golangci-lint/pkg/golinters/gosec"
	"github.com/doitforme/golangci-lint/pkg/golinters/gosimple"
	"github.com/doitforme/golangci-lint/pkg/golinters/gosmopolitan"
	"github.com/doitforme/golangci-lint/pkg/golinters/govet"
	"github.com/doitforme/golangci-lint/pkg/golinters/grouper"
	"github.com/doitforme/golangci-lint/pkg/golinters/iface"
	"github.com/doitforme/golangci-lint/pkg/golinters/importas"
	"github.com/doitforme/golangci-lint/pkg/golinters/inamedparam"
	"github.com/doitforme/golangci-lint/pkg/golinters/ineffassign"
	"github.com/doitforme/golangci-lint/pkg/golinters/interfacebloat"
	"github.com/doitforme/golangci-lint/pkg/golinters/intrange"
	"github.com/doitforme/golangci-lint/pkg/golinters/ireturn"
	"github.com/doitforme/golangci-lint/pkg/golinters/lll"
	"github.com/doitforme/golangci-lint/pkg/golinters/loggercheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/maintidx"
	"github.com/doitforme/golangci-lint/pkg/golinters/makezero"
	"github.com/doitforme/golangci-lint/pkg/golinters/mirror"
	"github.com/doitforme/golangci-lint/pkg/golinters/misspell"
	"github.com/doitforme/golangci-lint/pkg/golinters/mnd"
	"github.com/doitforme/golangci-lint/pkg/golinters/musttag"
	"github.com/doitforme/golangci-lint/pkg/golinters/nakedret"
	"github.com/doitforme/golangci-lint/pkg/golinters/nestif"
	"github.com/doitforme/golangci-lint/pkg/golinters/nilerr"
	"github.com/doitforme/golangci-lint/pkg/golinters/nilnesserr"
	"github.com/doitforme/golangci-lint/pkg/golinters/nilnil"
	"github.com/doitforme/golangci-lint/pkg/golinters/nlreturn"
	"github.com/doitforme/golangci-lint/pkg/golinters/noctx"
	"github.com/doitforme/golangci-lint/pkg/golinters/nolintlint"
	"github.com/doitforme/golangci-lint/pkg/golinters/nonamedreturns"
	"github.com/doitforme/golangci-lint/pkg/golinters/nosprintfhostport"
	"github.com/doitforme/golangci-lint/pkg/golinters/paralleltest"
	"github.com/doitforme/golangci-lint/pkg/golinters/perfsprint"
	"github.com/doitforme/golangci-lint/pkg/golinters/prealloc"
	"github.com/doitforme/golangci-lint/pkg/golinters/predeclared"
	"github.com/doitforme/golangci-lint/pkg/golinters/promlinter"
	"github.com/doitforme/golangci-lint/pkg/golinters/protogetter"
	"github.com/doitforme/golangci-lint/pkg/golinters/reassign"
	"github.com/doitforme/golangci-lint/pkg/golinters/recvcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/revive"
	"github.com/doitforme/golangci-lint/pkg/golinters/rowserrcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/sloglint"
	"github.com/doitforme/golangci-lint/pkg/golinters/spancheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/sqlclosecheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/staticcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/stylecheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/tagalign"
	"github.com/doitforme/golangci-lint/pkg/golinters/tagliatelle"
	"github.com/doitforme/golangci-lint/pkg/golinters/tenv"
	"github.com/doitforme/golangci-lint/pkg/golinters/testableexamples"
	"github.com/doitforme/golangci-lint/pkg/golinters/testifylint"
	"github.com/doitforme/golangci-lint/pkg/golinters/testpackage"
	"github.com/doitforme/golangci-lint/pkg/golinters/thelper"
	"github.com/doitforme/golangci-lint/pkg/golinters/tparallel"
	"github.com/doitforme/golangci-lint/pkg/golinters/unconvert"
	"github.com/doitforme/golangci-lint/pkg/golinters/unparam"
	"github.com/doitforme/golangci-lint/pkg/golinters/unused"
	"github.com/doitforme/golangci-lint/pkg/golinters/usestdlibvars"
	"github.com/doitforme/golangci-lint/pkg/golinters/usetesting"
	"github.com/doitforme/golangci-lint/pkg/golinters/varnamelen"
	"github.com/doitforme/golangci-lint/pkg/golinters/wastedassign"
	"github.com/doitforme/golangci-lint/pkg/golinters/whitespace"
	"github.com/doitforme/golangci-lint/pkg/golinters/wrapcheck"
	"github.com/doitforme/golangci-lint/pkg/golinters/wsl"
	"github.com/doitforme/golangci-lint/pkg/golinters/zerologlint"
...
func (LinterBuilder) Build(cfg *config.Config) ([]*linter.Config, error) {
	...
	return []*linter.Config{
		...
		linter.NewConfig(nolintlint.New(&cfg.LintersSettings.NoLintLint)).
			...
			WithPresets(linter.PresetStyle).
			WithAutoFix().
			WithURL("https://github.com/doitforme/golangci-lint/tree/HEAD/pkg/golinters/nolintlint/internal"),
	}, nil
}
